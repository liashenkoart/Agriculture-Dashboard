...
const getHistoricalMinTemp = (historical) => historical.time.map((item, index) => ({
...
const getForecastMinArr = (forecast) => forecast['t2m_min']['0.5'];
const getForecastMaxArr = (forecast) => forecast['t2m_max']['0.5'];
